...
class Market:
    ...
    def generate_preferences(
        ...
        self.pref_left_to_right = np.random.random((self.num_left, self.num_right))  # Generate random preferences
    ...
    def get_match_prob(
        ...
        return left_like_prob * right_likeprob.T  # Match probabilities between left and right side agents (num_left, num_right)
    ...
    def expected_matches_of_one_agent(
        ...
        """Return the expected number of matches of one agent given preferences, examination vector, and stochastic policy. This function is used in check_envy.
