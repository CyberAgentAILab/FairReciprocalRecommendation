...
def nsw_sinkhorn(
    ...
    """Return stochastic policies for left and right users computed via the approximate NSW maximization with Sinkhorn updates.
...
def sw_sinkhorn(
    ...
    """Return stochastic policies for left and right users computed via the approximate SW maximization with Sinkhorn updates.
